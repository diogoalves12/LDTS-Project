...
set CLASSPATH=%APP_HOME%\lib\Minesweeper-1.0-SNAPSHOT.jar;%APP_HOME%\lib\lanterna-3.1.2.jar


@rem Execute Minesweeper
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MINESWEEPER_OPTS%  -classpath "%CLASSPATH%" minesweeper.Main %*
...
if not ""=="%MINESWEEPER_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
